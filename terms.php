...
<head>
  <!-- Title -->
  <title>Terms & Conditions | Uxory Digital Solutions LLC</title>
  <meta name="description" content="Read the terms and conditions that govern your use of Uxory’s website, services, and digital solutions. Stay informed and protected." />
  ...
  <!-- Canonical -->
  <link rel="canonical" href="https://uxory.com/terms.php" />

  <!-- Open Graph -->
  <meta property="og:title" content="Terms & Conditions | Uxory Digital Solutions LLC" />
  <meta property="og:description" content="Understand the terms that apply when using Uxory’s digital products and services." />
  <meta property="og:image" content="https://uxory.com/images/logo.png" />
  <meta property="og:url" content="https://uxory.com/terms.php" />
  <meta property="og:type" content="website" />

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Terms & Conditions | Uxory Digital Solutions LLC" />
  <meta name="twitter:description" content="Understand the terms that apply when using Uxory’s digital products and services." />
  ...
  <div class="container reveal-me">
    <div class="text-center">
      ...
      <div class="rv-badge mb-4 md:mb-8">
        <span class="rv-badge-text">Terms</span>
      </div>

      <!-- Main page heading with dark mode support -->
      <h1 class="dark:text-white">Terms & Privacy</h1>
    </div>
  </div>
</section>

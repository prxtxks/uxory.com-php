...
<head>
  ...
  <title>Software Development Services | Uxory</title>
  <meta name="description" content="Custom software development by Uxory. We build secure, scalable, and AI-enabled systems that automate work, power products, and grow with your business." />
  ...
  <!-- Canonical URL -->
  <link rel="canonical" href="https://uxory.com/software-dev.php" />
  ...
  <meta property="og:url" content="https://uxory.com/software-dev.php" />
  <meta property="og:title" content="Software Development Services | Uxory" />
  <meta property="og:description" content="Custom software development by Uxory. We build secure, scalable, and AI-enabled systems that automate work, power products, and grow with your business." />
  <meta property="og:image" content="https://uxory.com/images/logo.png" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="630" />
  <meta property="og:image:alt" content="Uxory Software Development Services" />
  <meta property="og:site_name" content="Uxory" />
  <meta property="og:locale" content="en_US" />
  
  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:url" content="https://uxory.com/software-dev.php" />
  <meta name="twitter:title" content="Software Development Services | Uxory" />
  <meta name="twitter:description" content="Custom software development by Uxory. We build secure, scalable, and AI-enabled systems that automate work, power products, and grow with your business." />
  <meta name="twitter:image" content="https://uxory.com/images/logo.png" />
  <meta name="twitter:image:alt" content="Uxory Software Development Services" />
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "@id": "https://uxory.com/software-dev.php#service",
        "name": "Software Development Services",
        "description": "Custom software development services including custom business software, SaaS product development, and AI-powered software systems. We build secure, scalable systems that automate work, power products, and grow with your business.",
        "provider": {
          "@id": "https://uxory.com/#organization"
        },
        "url": "https://uxory.com/software-dev.php",
        "serviceType": "Software Development, Custom Software, SaaS Development, AI-Powered Software",
        "areaServed": [
          {
            "@type": "Country",
            "name": "United States"
      ...
      {
        "@type": "WebPage",
        "@id": "https://uxory.com/software-dev.php#webpage",
        "url": "https://uxory.com/software-dev.php",
        "name": "Software Development Services | Uxory",
        "description": "Custom software development by Uxory. We build secure, scalable, and AI-enabled systems that automate work, power products, and grow with your business.",
        "isPartOf": {
  ...
  <div class="swiper overflow-hidden reveal-me" id="reviewer">
      ...
      <div class="absolute right-[15%] bottom-[0px] z-50">
        <div class="flex items-center space-x-2">
          <button
            class="swiper-button-prev p-1.5 md:p-2.5 bg-secondary border border-secondary active:bg-primary hover:bg-primary duration-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
          ...
          <button
            class="swiper-button-next p-1.5 md:p-2.5 bg-secondary border border-secondary active:bg-primary hover:bg-primary duration-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"

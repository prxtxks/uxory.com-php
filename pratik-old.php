...
<head>
  <!-- Title -->
  <title>Pratik Chaudhari | Uxory Digital Solutions</title>
  ...
  <script type="application/ld+json">
    {
      ...
      "jobTitle": "Director & Chief Technology Officer",
      "worksFor": {
        "@type": "Organization",
        "name": "Uxory Technologies Pvt. Ltd.",
        "url": "https://uxory.com"
      },
      "email": "mailto:pratik@uxory.com",
      "telephone": "+91 73506 77916",
      "url": "https://uxory.com/pratik",
      "sameAs": [
        "mailto:contact@uxory.com",
        "https://wa.me/917350677916"
      ]
    }
  </script>
</head>
  ...
  <div class="container">
    ...
    >
      ...
      <div class="flex-1">
        ...
        <p class="py-4 md:py-10 border-t dark:border-dark">
          Welcome! I’m Pratik Chaudhari, Director of Uxory Technologies — glad to connect with you.
        </p>
    ...
    <div class="flex flex-col md:flex-row mt-14 pb-10 gap-6">
      ...
      >
        ...
        <a href="/pratik-chaudhari.vcf" download>
          <figure
      ...
      >
        ...
        <ul class="flex gap-x-10 gap-y-5 md:self-end">
          <!-- Mail -->
          <li>
            <a target="_blank" href="mailto:pratik@uxory.com">
              <img
          ...
          <!-- Whatsapp -->
          <li>
            <a target="_blank" href="https://wa.me/917350677916">
              <img
          ...
          <!-- Phone -->
          <li>
            <a target="_blank" href="tel:+917350677916">
              <img
        ...
        <p class="py-4 font-bold">
          <span href="mailto:rajesh@uxory.com" class="hover:underline">pratik@uxory.com</span> | 
          <span href="tel:+919403383635" class="hover:underline">+91 73506 77916</span> |
                    <span href="tel:+919403383635" class="hover:underline">+1 (513) 413-7427</span>

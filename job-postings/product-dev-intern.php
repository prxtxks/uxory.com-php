...
<head>
  <!-- Title -->
  <title>Product Development Intern | Uxory Careers</title>
  <meta name="description" content="Join Uxory as a Product Development Intern. Contribute to innovative digital solutions, work with experienced developers, and gain hands-on startup experience." />
  ...
  <!-- Canonical -->
  <link rel="canonical" href="https://uxory.com/product-dev-intern.php" />

  <!-- Open Graph -->
  <meta property="og:title" content="Product Development Intern | Uxory Careers" />
  <meta property="og:description" content="Join Uxory as a Product Development Intern. Contribute to innovative digital solutions, work with experienced developers, and gain hands-on startup experience." />
  <meta property="og:image" content="https://uxory.com/images/logo.png" />
  <meta property="og:url" content="https://uxory.com/product-dev-intern.php" />
  <meta property="og:type" content="website" />

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Product Development Intern | Uxory Careers" />
  <meta name="twitter:description" content="Join Uxory as a Product Development Intern. Contribute to innovative digital solutions, work with experienced developers, and gain hands-on startup experience." />
  ...
  <script type="application/ld+json">
  {
    ...
    "description": "Join Uxory as a Product Development Intern. Contribute to innovative digital solutions, work with experienced developers, and gain hands-on startup experience.",
    "hiringOrganization": {
      "@type": "Organization",
      "name": "Uxory",
    ...
    "url": "https://uxory.com/product-dev-intern.php"
  }
  </script>
</head>
...
<section class="pt-[220px] pb-20 lg:pb-[100px] relative">
  ...
  <div class="container text-center reveal-me">
    <div class="rv-badge mb-4">
      <span class="rv-badge-text">Product Design</span>
    </div>
    <div class="rv-badge mb-4">
    ...
    <h2 class="mb-5 md:mb-8 font-medium">Product Designer Intern</h2>
  </div>
</section>
  ...
  <div class="max-w-[1440px] mx-auto px-10 md:px-20">
    <div>
      ...
      <div id="tab-content-container">
        ...
        <div class="tab-content" id="Overview">
          <div class="flex flex-col gap-8 lg:flex-row lg:items-start">
            ...
            <article class="blog-details-body reveal-me">
              ...
              <p>We are looking for thoughtful product designer interns to help craft intuitive user experiences by blending research, design, and strategy into powerful digital products.</p>

              <h3 id="responsibilities">Responsibilities</h3>
              <p>As a Product Designer Intern, you will be responsible for:</p>
              <ul>
                <li>
                  Conduct UX research and user behavior analysis
                </li>
                <li>
                  Create user flows, wireframes, and interactive prototypes
                </li>
                <li>
                  Collaborate with cross-functional teams to align design and development
                </li>
                <li>
                  Apply feedback and test results to improve design iterations
                </li>
              </ul>
              ...
              <ul>
                <li>Understanding of user research methods and product design principles</li>
                <li>
                  Experience with prototyping tools like Figma or Adobe XD
                </li>
                <li>
                  Strong communication and storytelling through design
                </li>
              ...
              <ul>
                <li>Real-world product experience with end-to-end design involvement</li>
                <li>Flexible work arrangements with remote options</li>
                <li>Personalized mentorship and a US-based certification</li>
                <li>Bonus opportunities and leadership potential in design</li>
              </ul>
        ...
        <!-- Apply tab content -->
        <?php 
        $positionTitle = 'Product Development Intern';

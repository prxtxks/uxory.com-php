...
<head>
  <!-- Title -->
  <title>Website Developer Intern | Uxory – Build Real Projects</title>
  <meta name="description" content="Apply for the Website Developer Intern position at Uxory. Build real websites, strengthen your front-end and back-end skills, and work in a collaborative startup environment." />
  ...
  <!-- Canonical -->
  <link rel="canonical" href="https://uxory.com/web-dev-intern.php" />

  <!-- Open Graph -->
  <meta property="og:title" content="Website Developer Intern | Uxory – Build Real Projects" />
  <meta property="og:description" content="Apply for the Website Developer Intern position at Uxory. Build real websites, strengthen your front-end and back-end skills, and work in a collaborative startup environment." />
  <meta property="og:image" content="https://uxory.com/images/logo.png" />
  <meta property="og:url" content="https://uxory.com/web-dev-intern.php" />
  <meta property="og:type" content="website" />

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Website Developer Intern | Uxory – Build Real Projects" />
  <meta name="twitter:description" content="Apply for the Website Developer Intern position at Uxory. Build real websites, strengthen your front-end and back-end skills, and work in a collaborative startup environment." />
  ...
  <script type="application/ld+json">
  {
    ...
    "description": "Apply for the Website Developer Intern position at Uxory. Build real websites, strengthen your front-end and back-end skills, and work in a collaborative startup environment.",
    "hiringOrganization": {
      "@type": "Organization",
      "name": "Uxory",
    ...
    "directApply": true,
    "url": "https://uxory.com/web-dev-intern.php"
  }
  </script>
</head>
...
<section class="pt-[220px] pb-20 lg:pb-[100px] relative">
  ...
  <div class="container text-center reveal-me">
    ...
    <h2 class="mb-5 md:mb-8 font-semibold">Website Developer Intern</h2>
  </div>
</section>
      ...
      <div id="tab-content-container">
        ...
        <div class="tab-content" id="Overview">
          <div class="flex flex-col gap-8 lg:flex-row lg:items-start">
            ...
            <p>
              We are looking for detail-oriented website developer interns to design and build fast, responsive websites using HTML, CSS, JavaScript, and CMS platforms.
            </p>

            <!-- Responsibilities -->
            <h3 id="responsibilities">Responsibilities</h3>
            <p>As a Web Developer Intern, you will be responsible for:</p>

            <ul>
              <li>
                Develop visually appealing and mobile-friendly websites from scratch or templates
              </li>
              <li>
                Assist with WordPress development and basic plugin integrations
              </li>
              <li>
                Ensure cross-browser compatibility and fast loading times
              </li>
              <li>
                Apply basic SEO and accessibility standards to web pages
              </li>
            </ul>
            ...
            <ul>
              <li>Proficiency in HTML, CSS, and JavaScript fundamentals</li>
              <li>
                Interest in learning WordPress, SEO, and web performance optimization
              </li>
              <li>
                Strong attention to detail and design-to-code accuracy
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>Hands-on website projects with mentorship and design collaboration</li>
              <li>Certification and resume-enhancing experience with a US-based team</li>
              <li>Access to bonuses and real-world client exposure</li>
            </ul>
            <p>
